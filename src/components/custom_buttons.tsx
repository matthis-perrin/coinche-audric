...
export const CustomButton: React.FC<CustomButtonProps> = (props) => {
  ...
  if (props.icon !== undefined) {
    ...
    if (props.text !== undefined) {
      buttonContent.push(<Separator key="separator" style={{width: fontSize * ratioSeparatorWidth}}></Separator>);
    }
  }
  if (props.text !== undefined) {
    buttonContent.push(
      <ButtonText key="text" style={{fontSize, color: props.keyboardStyle ? keyboardColor : buttonColor}}>
        {props.text}
      </ButtonText>
    );
  }
